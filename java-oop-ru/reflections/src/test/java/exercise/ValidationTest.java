...
class ValidationTest {
    ...
    void testAdvancedValidate() {
        ...
        Address address2 = new Address("USA", null, null, null, "1");
        ...
        expected2.put("city", List.of("can not be null"));
        expected2.put("street", List.of("can not be null"));
        expected2.put("houseNumber", List.of("can not be null"));
        assertThat(result2).isEqualTo(expected2);

        Address address3 = new Address(null, "London", "1-st street", "5", "1");
        Map<String, List<String>> result3 = Validator.advancedValidate(address3);
        Map<String, List<String>> expected3 = new HashMap<>();
        expected3.put("country", List.of("can not be null", "length less than 4"));
        assertThat(result3).isEqualTo(expected3);
    }
    // END
}
